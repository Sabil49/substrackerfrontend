...
import { cancelAllScheduledNotifications, getScheduledNotifications } from '@/services/notifications'
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        <View style={[styles.section, { 
          ...
          <View style={styles.sectionHeader}>
            ...
            <Text style={[styles.sectionTitle, { color: colors.text.primary }]}>Notification Tips</Text>
          </View>

          <View style={styles.tipItem}>
            <View style={[styles.tipBullet, { backgroundColor: colors.badge.silent }]} />
